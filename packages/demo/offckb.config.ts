...
export function readEnvNetwork(): "devnet" | "testnet" | "mainnet" {
  ...
  if (typeof window !== "undefined") {
    //@ts-expect-error inject NETWORK into the global var
...
const lumosConfig: config.Config = {
  ...
  SCRIPTS: {
    ...
    NOSTR_BINDING: {
      CODE_HASH:
        "0x5ea4b9d50093a19943dc788c15bbdf7cd9d89efd67989a18b162feca814d90bb",
      HASH_TYPE: "type",
      TX_HASH:
        "0x8e5f51f2e0a5a4aedfd310ad4174e45a65009f6f13c3f8c24a3ffd2939a75aa4",
      INDEX: "0x0",
      DEP_TYPE: "code",
    },
    NOSTR_LOCK: {
      CODE_HASH:
        "0xc991186b2720166187113e1da22a92db306ddc8a8f46c7c85846b8559d4fdd11",
      HASH_TYPE: "type",
      TX_HASH:
        "0x7261c51659a695e135bb3a56c83e878a271125244665b208a586c4329ce1b1a9",
      INDEX: "0x0",
      DEP_TYPE: "code",
    },
  },
